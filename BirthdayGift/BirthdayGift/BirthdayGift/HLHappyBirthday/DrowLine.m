...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        [WPDrowAnimationLayer createAnimationLayerWithString:People_Name rect:CGRectMake(Windows_Width / 2 - 150, 250, 300, 150) view:self font:[UIFont systemFontOfSize:40] duretion:5];
        [WPDrowAnimationLayer createAnimationLayerWithString:Blessing rect:CGRectMake(Windows_Width / 2 - 150, Windows_Height - 150, 300, 150) view:self font:[UIFont systemFontOfSize:40] duretion:5];
    }
    return self;
}
...
-(void)bigBox{
    ...
    CGPoint point3          = CGPointMake(Windows_Width - 10,Windows_Height - 20-49);
    CGPoint point4          = CGPointMake(10, Windows_Height - 20-49);
...
-(void)smallBox{
    ...
    CGPoint point2              = CGPointMake(20, Windows_Height - 30-49);
    CGPoint point3              = CGPointMake(Windows_Width - 20,Windows_Height - 30-49);
